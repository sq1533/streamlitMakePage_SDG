...
st.html(
    ...
    <div class="login-container">
        <a href="{api.guest.naverSignUP(pageState=current_page_state)}" class="social-login-btn naver-login" target="_self">
            <span class="social-logo naver-logo"></span>
            <span class="btn-text">네이버로 시작하기</span>
        </a>
        <a href="{api.guest.kakaoSignUP(pageState=current_page_state)}" class="social-login-btn kakao-login" target="_self">
            <span class="social-logo kakao-logo"></span>
            <span class="btn-text">카카오로 시작하기</span>
        </a>
        <a href="{api.guest.gmailSignUP(pageState=current_page_state)}" class="social-login-btn gmail-login" target="_self">
